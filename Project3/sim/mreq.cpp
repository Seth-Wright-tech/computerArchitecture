...
void Mreq::print_msg (ModuleID mid, const char *add_msg)
{
    ...
    fprintf (stdout, "tag: 0x%8llx clock: %8lld ", (long long int)addr>>settings.cache_line_size_log2, (unsigned long long) Global_Clock);
...
void Mreq::dump ()
{
    ...
    fprintf (stdout, "0x%8llx Clock: %8lld %20s\n",
             (long long int)addr, (unsigned long long)Global_Clock, Mreq::message_t_str[msg]);
#endif
}
